...
export default function PackagingLoginPage() {
    ...
    <div className="bg-[#F9F9F9] min-h-screen flex items-center justify-center">
      <div className="bg-white border border-[#E5E7EB] rounded-lg shadow-sm p-8 w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[#6B7280] mt-1">Packaging Portal</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <MInput
            label="Email"
            type="email"
            placeholder="packaging@manola.com"
            value={email}
