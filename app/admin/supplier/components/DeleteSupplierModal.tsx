...
export function DeleteSupplierModal({
  ...
  supplier,
  onConfirm,
  submitting }: DeleteSupplierModalProps) {
  return (
    <MModal
      isOpen={isOpen}
      onClose={onClose}
    ...
    >
      <div className="text-center py-4">
        ...
        <p className="text-[#0A0A0A] font-medium">Hapus Supplier?</p>
        <p className="text-sm text-[#6B7280] mt-1">
          Supplier <span className="font-semibold text-[#0A0A0A]">{supplier?.nama}</span> akan
